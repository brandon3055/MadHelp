...
public class GuiConfirmDownload extends GuiYesNo {
    ...
    public void initGui() {
        ...
        if (!regional)
            this.buttonList.add(new GuiButton(1, this.width / 2 - 50, this.height / 6 + 96, 100, 20, I18n.format("gui.mad.useExisting.button")));
    ...
    public void drawScreen(int x, int y, float p_73863_3_) {
        ...
        if (!regional) {
            fontRenderer.drawSplitString(I18n.format("gui.mad.reDownload1.info"), 20, 60, width - 40, 16777215);
            fontRenderer.drawSplitString(TextFormatting.GREEN + I18n.format("gui.mad.reDownload2.info"), 20, 90, width - 40, 16777215);
        }
        else {
            fontRenderer.drawSplitString(I18n.format("gui.mad.regionWarning1.info"), 20, 60, width - 40, 16777215);
            GuiHelper.drawCenteredSplitString(fontRenderer, I18n.format("Do you want to continue?"), width / 2, 130, width - 40, 16777215, false);
        }
    }
