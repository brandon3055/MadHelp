...
public class GuiSelectWorld extends GuiScreen {
	...
	public void initGui() {
		super.initGui();
		this.mapList.clear();
		for (File file : new File(FileHandler.mcDirectory, "saves").listFiles(new ContentHandler.FilterFolders())) this.mapList.add(new Pair<String, String>(file.getName(), file.getPath()));
	...
	public void drawScreen(int x, int y, float tick) {
		...
		fontRendererObj.drawSplitString(TextFormatting.RED + I18n.format("gui.mad.selectWorldWarning"), 20, 8, width - 20, 0x909090);
//		fontRendererObj.drawSplitString(TextFormatting.RED + "Continue?", 20, 8, width - 20, 0x909090);
	}
	...
	class SelectionList extends GuiSlot
	{
		...
		@Override
		protected void drawSlot(int index, int x, int y, int var4, int var5, int var6)
		{
			...
			GuiSelectWorld.this.drawString(GuiSelectWorld.this.fontRendererObj, name, x + 2, y + 1, 0xFFFFFF);
			GuiSelectWorld.this.fontRendererObj.drawSplitString(path, x + 2, y + 12, width - ((x + 2) * 2), 0x808080);
		}
	}
}
